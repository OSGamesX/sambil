...
function Interaction() {
	...
	var dialogues = {
		...
		'npc-stamina' : {
			char: dialogueChars.lady,
			story: [
				{ m: `You may be too weak to climb some walls... Try to find some Sambil, they will increase your stamina and make you stronger !` },
				{ m: `Have a look into this abandoned mine. Once in a while an Sambil would bloom there.` }
			]
		},
		...
		'npc-wall-medium' : {
			...
			story: [
				...
				{ m: `If you don't have enough stamina, consider going back to find another Sambil, to have at least 4 stamina bars.` }
			]
		},
		...
		'npc-wall-hard' : {
			...
			story: [
				...
				{ m: `If you don't have enough stamina, consider going back to find an Sambil.` }
			]
		},
		...
		'dev-greeting' : {
			...
			story: [
				...
				{ m: `Let me check your stamina... It seems that you still have some Sambil yet to find.` },
		...
		'dev-greeting-finish' : {
			...
			story: [
				{ m: 'Ho ! A player !' },
				{ m: 'Congratulations, you reached the top of the mountain !' },
				{ m: `Let me check your stamina... Waw ! You found all the Sambil !` },
		...
		'dev-main-finish' : {
			...
			story: [
				{ m: "Thank you for you commitment in the game, that's encouraging for me." },
				{ m: `Let me check your stamina... Well, you found all the Sambil !` },
				{ m: "As it looks like you appreciate my games, be sure to stay tuned for the next release on <a target='_blank' href='https://twitter.com/felix_mariotto'>https://twitter.com/felix_mariotto</a>" },
				{ question: 'Do you want to save your progression ?', answers: [
					{ m: 'Yes', next: 'yes' },
					{ m: 'No', next: 'no' }
